...
#                                            # if both are not set only enabled display will be used to determine if the macuser is present
#my $ccu2address         = "192.168.2.3";
my $hmccuvariable       = "presence.mac.officeuser";
my $debug               = 0;
...
my $ccu2address         = "hausautomation.jinx.eu";
